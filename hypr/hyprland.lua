...
local terminal = "ghostty +new-window -e fish"
...
hl.on("hyprland.start", function()
	...
	-- hl.exec_cmd("gio launch ~/.config/autostart/discord.desktop")
end)
-------------------------------
...
hl.bind(mainMod .. " + SHIFT_R", hl.dsp.exec_cmd("google-chrome-stable"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("resources"))
...
hl.window_rule({
	name = "chrome_starting_width",
	match = { class = "google-chrome" },
	scrolling_width = 1,
})
hl.window_rule({
	name = "steam_start_width",
	match = { class = "steam", title = "Steam" },
	scrolling_width = 1,
})
hl.window_rule({
	name = "resources_start_width",
